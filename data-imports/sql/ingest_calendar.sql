CREATE OR REPLACE TRANSIENT TABLE &table_destination (
    ...
    DATE DATE NOT NULL COMMENT 'Date of availability this row describes. Part of the primary key.',
    AVAILABLE BOOLEAN NOT NULL COMMENT 'Contains \'t\' if this property is available on this date. Contains \'f\' if not.',
    RESERVATION_ID INTEGER NULL COMMENT 'Unique ID for that date\'s reservation. Foreign key. If NULL, there was no reservation on that date.',
